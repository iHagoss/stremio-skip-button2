...
class SettingsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val externalPlayerToggle = findViewById<SwitchCompat>(R.id.externalPlayerToggle)
        ...
        // Load external player integration preference
        externalPlayerToggle.isChecked = prefs.getBoolean("pref_integrate_external_players", false)
        ...
        saveButton.setOnClickListener {
            prefs.edit()
                ...
                .putBoolean("pref_integrate_external_players", externalPlayerToggle.isChecked)
                .apply()
